...
// First Hindi Details
    ...
    $pdf->Ln();
    $pdf->SetFont('kurti-dev-040-bold','',16);
    $pdf->Cell(0,$LINE_SPACING,'O;olk; izca/ku vf/kLukrd','','','C');
...
//English Typing
    ...
    $pdf->Ln();
    $pdf->SetFont('times','B',12);
    $pdf->Cell(0,0,'MASTER OF BUSINESS ADMINISTRATION','','','C');
    $pdf->SetFont('times','',12);
    $pdf->Ln();
